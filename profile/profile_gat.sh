...
"${PYTHON}" ${PROJECT_HOME}/parser.py --folder ${OUTPUT_DIR} --file ${NVPROF_OUT} --csv ${STATS_CSV}

"${PYTHON}" ${PROJECT_HOME}/plot_tradeoffs.py --csv $STATS_CSV --machine $MACHINE --plotdir $OUTPUT_DIR/graphs